...
class Douyin:
    ...
    def get_douyin_url(self):
        ...
        try:
            oresp = session.get(live_url, headers=headers, timeout=10)  # Set timeout here
            oresp.close()
            ...
            resp = session.get(live_url, headers=headers, timeout=10)  # Set timeout here
            ...
            ress = session.get(url, headers=headers, timeout=10)  # Set timeout here
            ress.close()
            ...
            return "RequestTimeout"  # Return a message indicating a timeout occurred
